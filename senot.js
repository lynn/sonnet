...
function isntDigit(c) {
    return !isDigit(c);
}
function isPunctuation(c) {
    return c === "." || c === ",";
}
function isntPunctuation(c) {
...
function main() {
    ...
    var stroke = [];
    var stroking = false;
    var shiftStroke = false;
    var capitalizeNext = false;
    var strokeTimeout = undefined;
    var results = [];
    var startedTypingTime = undefined;
    var cpm = NaN;
    var lastStrokeName = "";
    function updateCpm() {
        if (buffer) {
